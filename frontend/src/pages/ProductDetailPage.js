// ============================================
// Trang Chi tiết sản phẩm - CẬP NHẬT: Toast thay alert
// File: frontend/src/pages/ProductDetailPage.js — GHI ĐÈ
// ============================================
  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        message="Bạn cần đăng nhập để thêm sản phẩm vào giỏ hàng. Đăng nhập ngay?"
